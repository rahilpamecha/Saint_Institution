...
$sql = "SELECT name, percent FROM results WHERE course='$_GET[exam_name]' ";
...
?>
 ...
 alert("   "+b+' Result- '+c); 
  window.location.href = 'allresult.php';                                      //when this DOES execute in the browser, PHP will have already completed all processing and exited
</script>
